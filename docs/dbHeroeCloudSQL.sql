...
CREATE TABLE protagonistas_ds (
    ...
    CONSTRAINT protagonistas_ds_heroes_fk FOREIGN KEY (heroes_id) REFERENCES heroes_ds(id),
    CONSTRAINT protagonistas_ds_peliculas_fk FOREIGN KEY (peliculas_id) REFERENCES peliculas_ds(id)
);
...
CREATE TABLE multimedias_heroe_ds (
    ...
    CONSTRAINT multimedias_heroe_ds_heroes_fk FOREIGN KEY (heroes_id) REFERENCES heroes_ds(id),
    CONSTRAINT multimedias_heroe_ds_multimedia_fk FOREIGN KEY (idmultimedia) REFERENCES multimedias_ds(idmultimedia)
);
